...
const navGroups = [
  ...
  },
  {
    ...
    icon: FileText,
    items: [
      { href: '/upload', label: 'Carregar', icon: Upload, tourId: 'nav-upload' },
      ...
      { href: '/export', label: 'Exportar', icon: FileOutput, tourId: 'nav-export' },
    ]
  },
  {
    id: 'fiscal',
    ...
    items: [
      ...
      { href: '/modelo-10', label: 'Modelo 10', icon: Receipt, tourId: 'nav-modelo10' },
  ...
  },
  {
    ...
    icon: PieChart,
    items: [
      { href: '/reports', label: 'Relatórios e Análise', icon: ClipboardList, tourId: 'nav-reports' },
    ]
  },
  {
    id: 'ajuda',
    ...
    icon: HelpCircle,
    items: [
      { href: '/glossario', label: 'Glossário Fiscal', icon: BookOpen, tourId: 'nav-glossario' },
    ]
  },
  {
    id: 'conta',
    ...
    icon: User,
    items: [
      { href: '/accountant', label: 'Contabilista', icon: Users, tourId: 'nav-accountant' },
