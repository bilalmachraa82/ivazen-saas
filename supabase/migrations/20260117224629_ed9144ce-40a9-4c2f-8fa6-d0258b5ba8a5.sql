-- 1. Create invoice_validation_logs table
...
-- Users can view logs for invoices they own or are accountants for
...
-- 2. Sync legacy data - insert missing client_accountants entries
...
CREATE INDEX idx_invoice_validation_logs_invoice_id ON public.invoice_validation_logs(invoice_id);
CREATE INDEX idx_invoice_validation_logs_user_id ON public.invoice_validation_logs(user_id);