  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(335 65% 55% / 0.15)" },
          "50%": { boxShadow: "0 0 35px hsl(335 65% 55% / 0.3)" },
        },
        "scale-in": {
        ...
        "pulse-cta": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(335 65% 55% / 0.4)" },
          "50%": { boxShadow: "0 0 0 12px hsl(335 65% 55% / 0)" },
        },
      },
      animation: {
        ...
        "spring-rotate": "spring-rotate 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",
